  ...
  return (
    <section id="certifications" className="w-full max-w-6xl mx-auto py-24 px-6 mb-20">
      ...
      <motion.div 
        ...
        className="flex sm:grid overflow-x-auto sm:overflow-visible snap-x snap-mandatory hide-scrollbar gap-6 pb-8 sm:pb-0 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4"
      >
